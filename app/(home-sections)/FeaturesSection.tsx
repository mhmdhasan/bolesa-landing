...
import { LuClipboard, LuTruck, LuReceiptText, LuBrain } from 'react-icons/lu';
    ...
    return (
        <section className='py-[60px] w-full overflow-hidden relative'>
            ...
            <div className='max-w-[1300px] w-full mx-auto relative z-20 text-center px-5'>
                <div className='grid grid-cols-1 xl:grid-cols-12 gap-3 items-end'>
                    <div className='flex flex-col items-start xl:col-span-7'>
                        <motion.div variants={fadeInUp(0.05)} className='mb-4'>
                            <div className='cursor-default bg-[#91b436]/5 border border-[#91b436]/20 inline-flex gap-2  w-fit backdrop-blur-lg text-md rounded-3xl px-5 py-1 shadow-[0_1px_5px_rgba(0,0,0,0.07)]'>
                ...
                {/* -------------------------------------------------------------- */}
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-2 mt-6 bg-muted rounded-2xl p-2 relative'>
                    <div className='rounded-xl text-white bg-[#060e00] p-8 relative overflow-hidden'>
                        ...
                        <div className='relative z-99 flex flex-col gap-2 text-start'>
                        ...
                        <div className='relative z-99 flex flex-col gap-2 text-start mt-7'>
                            <LuBrain className='size-7' />
